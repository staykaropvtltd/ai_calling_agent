...
Integration tests for SH-04 wiring:
  InputAudioRawFrame.audio ΓåÆ SttBridge ΓåÆ DeepgramSttSession ΓåÆ TranscriptEvent

All tests are fully mocked ΓÇö no real network, no pipecat import required.
...
def test_W11_open_session_error_caught_pipeline_continues():
    ...
    async def run():
        ...
        try:
            ...
            # _attach_stt swallows this ΓÇö pipeline continues without STT
            session_result = None
