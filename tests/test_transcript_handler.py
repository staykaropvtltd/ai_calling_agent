"""
Focused tests for the SH-04 → SH-06 transcript handoff (transcript_handler.py).

All tests are fully mocked — no Redis connection, no pipecat.
...
Coverage:
 ...
 H06  seq counter increments across calls (1, 2, 3, …)
