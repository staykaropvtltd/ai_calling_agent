...
def upgrade() -> None:
    ...
    op.create_index('idx_call_jobs_status_available', 'call_jobs', ['status', 'available_at'], unique=False)
    op.create_index('idx_call_jobs_tenant_status', 'call_jobs', ['tenant_id', 'status'], unique=False)
